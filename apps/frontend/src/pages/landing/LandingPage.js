    ...
    <main>  
        ...
        <section class="landing-hero flex flex-row items-center">
            ...
            <article class="landing-hero-content">
                <h1 class="landing-hero-title">${t("landing.hero.title")}</h1>
                <p class="landing-hero-desc">${t("landing.hero.desc")}</p>
                ${(() => {
                  const li = isAuthenticated();
                  return `
                <div class="hero-buttons">
                    <a class="link-report-issue" href="${li ? "/reports/create" : "/login"}" ${li ? 'data-link' : ''}>${t("landing.hero.report_btn")}</a> 
                    <a class="link-explore-report" href="${li ? "/reports" : "#explore-reports"}" ${li ? 'data-link' : ''}>${t("landing.hero.explore_btn")}</a>
                </div>`;
                })()}
            </article>
        </section>
        ...
        <section id="explore-reports" class="landing-explore">
            <div class="landing-explore-container">
                ...
                <article class="landing-explore-carousel">
                    <h3 class="landing-explore-label">${t("landing.sample.label")}</h3>
                    <div class="landing-explore-viewport">
                    <div class="landing-report-cards">
                    <div class="landing-report-card">
                        <div class="landing-report-card-img"><img src="/pothole-maple-treet.png" alt="${t("landing.sample.card1.title")}"></div>
                        <h4 class="landing-report-card-title">${t("landing.sample.card1.title")}</h4>
                        <div class="landing-report-card-field">
                            <h5 class="landing-report-card-label">${t("landing.sample.card1.category_label")}</h5>
                            <p>${t("landing.sample.card1.category")}</p>
                        </div>
                        <div class="landing-report-card-field">
                            <h5 class="landing-report-card-label">${t("landing.sample.card1.status_label")}</h5>
                            <p>${t("landing.sample.card1.status")}</p>
                        </div>
                        <div class="landing-report-card-field">
                            <h5 class="landing-report-card-label">${t("landing.sample.card1.location_label")}</h5>
                            <p>${t("landing.sample.card1.location")}</p>
                        </div>
                        <div class="landing-report-card-field">
                            <h5 class="landing-report-card-label">${t("landing.sample.card1.desc_label")}</h5>
                            <p>${t("landing.sample.card1.desc")}</p>
                        </div>
                    </div>

                    <div class="landing-report-card">
                        <div class="landing-report-card-img"><img src="/broken-street-light.png" alt="${t("landing.sample.card2.title")}"></div>
                        <h4 class="landing-report-card-title">${t("landing.sample.card2.title")}</h4>
                        <div class="landing-report-card-field">
                            <h5 class="landing-report-card-label">${t("landing.sample.card2.category_label")}</h5>
                            <p>${t("landing.sample.card2.category")}</p>
                        </div>
                        <div class="landing-report-card-field">
                            <h5 class="landing-report-card-label">${t("landing.sample.card2.status_label")}</h5>
                            <p>${t("landing.sample.card2.status")}</p>
                        </div>
                        <div class="landing-report-card-field">
                            <h5 class="landing-report-card-label">${t("landing.sample.card2.location_label")}</h5>
                            <p>${t("landing.sample.card2.location")}</p>
                        </div>
                        <div class="landing-report-card-field">
                            <h5 class="landing-report-card-label">${t("landing.sample.card2.desc_label")}</h5>
                            <p>${t("landing.sample.card2.desc")}</p>
                        </div>
                    </div>

                    <div class="landing-report-card">
                        <div class="landing-report-card-img"><img src="/fallen-tree-blocking-sidewalk.png" alt="${t("landing.sample.card3.title")}"></div>
                        <h4 class="landing-report-card-title">${t("landing.sample.card3.title")}</h4>
                        <div class="landing-report-card-field">
                            <h5 class="landing-report-card-label">${t("landing.sample.card3.category_label")}</h5>
                            <p>${t("landing.sample.card3.category")}</p>
                        </div>
                        <div class="landing-report-card-field">
                            <h5 class="landing-report-card-label">${t("landing.sample.card3.status_label")}</h5>
                            <p>${t("landing.sample.card3.status")}</p>
                        </div>
                        <div class="landing-report-card-field">
                            <h5 class="landing-report-card-label">${t("landing.sample.card3.location_label")}</h5>
                            <p>${t("landing.sample.card3.location")}</p>
                        </div>
                        <div class="landing-report-card-field">
                            <h5 class="landing-report-card-label">${t("landing.sample.card3.desc_label")}</h5>
                            <p>${t("landing.sample.card3.desc")}</p>
                        </div>
                    </div>
                ...
                <article class="landing-explore-info">
                    <h2 class="landing-explore-title">${t("landing.explore.title")}</h2>
                    <div class="landing-explore-textbox">
                        <p class="landing-explore-subtitle">${t("landing.explore.desc")}</p>
                    </div>
                </article>
        ...
        <section id="how-it-works" class="landing-how">
            <h1 class="landing-how-title">${t("landing.how.title")}</h1>
            <p class="landing-how-subtitle">${t("landing.how.subtitle")}</p>
            ...
            <div class="tl-container">
                ...
                <div class="tl-arc">
                    ...
                    <label class="tl-step" for="tl1" data-step="1">
                        ...
                        <span class="tl-lbl">${t("landing.how.step1_label")}</span>
                    </label>
                    <label class="tl-step" for="tl2" data-step="2">
                        <span class="tl-num">2</span>
                        <span class="tl-lbl">${t("landing.how.step2_label")}</span>
                    </label>
                    <label class="tl-step" for="tl3" data-step="3">
                        <span class="tl-num">3</span>
                        <span class="tl-lbl">${t("landing.how.step3_label")}</span>
                    </label>
                    <label class="tl-step" for="tl4" data-step="4">
                        <span class="tl-num">4</span>
                        <span class="tl-lbl">${t("landing.how.step4_label")}</span>
                    </label>
                </div>
                ...
                <div class="tl-cards">
                    <div class="tl-card" data-step="1">
                        ...
                        <h3 class="tl-card-title">${t("landing.how.step1_title")}</h3>
                        <p class="tl-card-desc">${t("landing.how.step1_desc")}</p>
                    </div>
                    <div class="tl-card" data-step="2">
                        ...
                        <h3 class="tl-card-title">${t("landing.how.step2_title")}</h3>
                        <p class="tl-card-desc">${t("landing.how.step2_desc")}</p>
                    </div>
                    <div class="tl-card" data-step="3">
                        ...
                        <h3 class="tl-card-title">${t("landing.how.step3_title")}</h3>
                        <p class="tl-card-desc">${t("landing.how.step3_desc")}</p>
                    </div>
                    <div class="tl-card" data-step="4">
                        ...
                        <h3 class="tl-card-title">${t("landing.how.step4_title")}</h3>
                        <p class="tl-card-desc">${t("landing.how.step4_desc")}</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="landing-action">
            <h2 class="landing-action-title">${t("landing.action.title")}</h2>
            <div class="landing-action-carousel">
                <div class="landing-action-card landing-action-card--blue">
                    ...
                    <h3 class="landing-action-card-title">${t("landing.action.card1_title")}</h3>
                    <p class="landing-action-card-desc">${t("landing.action.card1_desc")}</p>
                </div>
                <div class="landing-action-card landing-action-card--orange">
                    ...
                    <h3 class="landing-action-card-title">${t("landing.action.card2_title")}</h3>
                    <p class="landing-action-card-desc">${t("landing.action.card2_desc")}</p>
                </div>
                <div class="landing-action-card landing-action-card--gradient">
                    ...
                    <h3 class="landing-action-card-title">${t("landing.action.card3_title")}</h3>
                    <p class="landing-action-card-desc">${t("landing.action.card3_desc")}</p>
                    <a class="landing-action-btn" href="${isAuthenticated() ? "/home" : "/login"}" ${isAuthenticated() ? 'data-link' : ''}>${t("landing.action.cta")}</a>
                </div>
            </div>
        </section>
                ...
                <div class="about-right">
                    ...
                    <div class="about-wave-box">
                        ...
                        <label class="about-dot" for="ac-1" data-a="1">
                            ...
                            <span class="about-dot-label">${t("landing.about.mission_label")}</span>
                        </label>
                        <label class="about-dot" for="ac-2" data-a="2">
                            <span class="about-dot-ring"></span>
                            <span class="about-dot-label">${t("landing.about.vision_label")}</span>
                        </label>
                        <label class="about-dot" for="ac-3" data-a="3">
                            <span class="about-dot-ring"></span>
                            <span class="about-dot-label">${t("landing.about.objective_label")}</span>
                        </label>
                        <label class="about-dot" for="ac-4" data-a="4">
                            <span class="about-dot-ring"></span>
                            <span class="about-dot-label">${t("landing.about.values_label")}</span>
                        </label>
                        <label class="about-dot" for="ac-5" data-a="5">
                            <span class="about-dot-ring"></span>
                            <span class="about-dot-label">${t("landing.about.branding_label")}</span>
                        </label>
                    </div>
                    ...
                    <div class="about-cards-box">
                        <div class="about-card" data-a="1">
                            ...
                            <h3 class="about-card-title">${t("landing.about.mission_title")}</h3>
                            <p class="about-card-text">${t("landing.about.mission_desc")}</p>
                        </div>
                        ...
                        <div class="about-card" data-a="2">
                            ...
                            <h3 class="about-card-title">${t("landing.about.vision_title")}</h3>
                            <p class="about-card-text">${t("landing.about.vision_desc")}</p>
                        </div>
                        ...
                        <div class="about-card" data-a="3">
                            ...
                            <h3 class="about-card-title">${t("landing.about.objective_title")}</h3>
                            <p class="about-card-text">${t("landing.about.objective_desc")}</p>
                        </div>
                        ...
                        <div class="about-card" data-a="4">
                            ...
                            <h3 class="about-card-title">${t("landing.about.values_title")}</h3>
                            <div class="about-card-values">
                                <div class="about-val"><strong>${t("landing.about.value1_title")}</strong><span>${t("landing.about.value1_desc")}</span></div>
                                <div class="about-val"><strong>${t("landing.about.value2_title")}</strong><span>${t("landing.about.value2_desc")}</span></div>
                                <div class="about-val"><strong>${t("landing.about.value3_title")}</strong><span>${t("landing.about.value3_desc")}</span></div>
                                <div class="about-val"><strong>${t("landing.about.value4_title")}</strong><span>${t("landing.about.value4_desc")}</span></div>
                            </div>
                        </div>
                        ...
                        <div class="about-card" data-a="5">
                            ...
                            <h3 class="about-card-title">${t("landing.about.branding_title")}</h3>
                            <p class="about-card-text">${t("landing.about.branding_desc")}</p>
                        </div>
                    </div>
                </div>
            </div>
